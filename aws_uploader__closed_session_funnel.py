...
pa_schema = pa.schema([
    ...
    pa.field("started", pa.int64()),
    pa.field("added", pa.int64()),
    pa.field("went_cart", pa.int64()),
    pa.field("checkout", pa.int64()),
    pa.field("purchases", pa.int64()),
])
...
if __name__ == '__main__':
    ...
    with BigQueryExporter() as exporter:
        ...
        s3_entity_path = 'partner_metrics/interval_metrics/closed_session_funnel'
