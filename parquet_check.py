...
amplitude_08 = pq.read_table('temp/bigquery_export_xkcj2iys/export_organic-reef-315010.indrive.closed_session_funnel_20250916_111859.parquet')
amplitude_04 = pq.read_table('temp/bigquery_export_oznke0k9/export_organic-reef-315010.indrive.closed_session_funnel_20250916_111746.parquet')
...
# with open('scr/closed_session_funnel_schema.txt', 'w', encoding='utf-8') as f:
